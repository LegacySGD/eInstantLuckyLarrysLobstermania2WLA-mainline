...
public class LuckyLarrysLobstermania2TTTWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(LuckyLarrysLobstermania2TTTWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LuckyLarrysLobstermania2WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LuckyLarrysLobstermania2WLAIW/InitOutcome.xml").getDocumentElement();
